...
from model_GRUPFG import GRUPFG

# provider_uri = "~/.qlib/qlib_data/us_data"  # target_dir
provider_uri = "C:/Users/Administrator/Desktop/HIST-main/cn_data"  # target_dir
...
from model_hist import MLP, HIST
...
def get_model(model_name):
    ...
    if model_name.upper() == 'TRA':
        return TRA

    if model_name.upper() == 'GRUPFG':
        return GRUPFG
...
def main(args):
    ...
    for times in range(args.repeat):
        ...
        elif args.model_name == 'GRUPFG':
            model = get_model(args.model_name)(d_feat=args.d_feat, num_layers=args.num_layers, K=args.K)
        elif args.model_name == 'TRA':
            model = get_model(args.model_name)(input_size=args.hidden_size)
        else:
